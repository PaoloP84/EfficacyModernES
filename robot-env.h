/*
 * robot-env.h: The robot/environmental software component
 *
 * This .h file of the robot-environmental component include the definition
 * of the robot structure and of the envobjects structure, that include all variables associated to
 * a robot and to the object costituting the environment.
 * Moreover it declare functions that can be called by other software components, in particular
 * by the experimental component
 */
...
int updateRobot(struct robot *cro, double *actions);             // update the robot on the basis of the state of the robot motor
