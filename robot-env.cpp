/*
 * robot-env.cpp: The robot/environmental software component
 *
 * This component include functions for initializing the environmental objects and the robots
 * simulating the sensors of the robot
 * moving the robot by handling the effect of collisions
 * ***************************
 **************REMOVED include-network.h, changed parameters in update_robot(cro, *actions)
 */
 ...
 */
int updateRobot(struct robot *cro, double *actions)
